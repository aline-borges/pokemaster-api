...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { age: @trainer.age, name: @trainer.name, photo: @trainer.photo, sex: @trainer.sex } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { age: @trainer.age, name: @trainer.name, photo: @trainer.photo, sex: @trainer.sex } }
